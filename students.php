                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="add-records">
                                    <form id="addStdForm" method="post" onsubmit="return addSingle()">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Full name</label>
                                                    <input name="std_name" type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Parent full name</label>
                                                    <input name="std_p_name" type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="std_p_phone" type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Age (eg: 12)</label>
                                                    <input name="std_age" type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="std_address" type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="tab-pane" id="manage-data">
                                    ...
                                    <div style="max-height: 500px; overflow-y: auto; width: 100%">
                                        <table id="mytable" class="table" >
                                            ...
                                            <tbody>
                                            <?php getListStudentsQuery(50000, "") ?>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header card-header-success">
                            <h4 class="card-title">Tools Center (Students)</h4>
                        ...
                        <div class="card-body">
                            ...
                            <a href="template?type=std" target="_blank"
    ...
    <script>
        ...
        function addSingle() {
            ...
            $.ajax({
                type: "POST",
                url: "xapi",
                data: $('#addStdForm').serialize() + '&cmd=std&batch=false',
...
//                        window.location.href = 'students';
        ...
        function startUploading() {
            ...
            $('#filed').simpleUpload("xapi?cmd=std&batch=true", {
